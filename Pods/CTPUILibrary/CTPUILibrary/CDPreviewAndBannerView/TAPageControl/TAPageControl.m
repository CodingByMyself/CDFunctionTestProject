...
- (void)updateDotFrame:(UIView *)dot atIndex:(NSInteger)index
{
    ...
    CGFloat x = self.spacingBetweenDots + (self.dotSize.width + self.spacingBetweenDots) * index + ( (CGRectGetWidth(self.frame) - [self sizeForNumberOfPages:self.numberOfPages].width) / 2);
