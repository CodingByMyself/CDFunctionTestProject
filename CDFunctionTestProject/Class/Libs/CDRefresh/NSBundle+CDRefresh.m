...
@implementation NSBundle (CDRefresh)
...
+ (instancetype)mj_refreshBundle
{
    ...
    if (refreshBundle == nil) {
        ...
        refreshBundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[CDRefreshComponent class]] pathForResource:@"CDRefresh" ofType:@"bundle"]];
    }
